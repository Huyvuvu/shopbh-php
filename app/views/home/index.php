            ...
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        ...
                        <li data-filter=".vegetables">Oppo</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg">
                            <img class="img-fluid w-100" src="public/<?php echo $i['images']; ?>">
                        ...
                        <div class="featured__item__text">
                            <h6><a
                                    href="index.php?con=ProductController&act=detail&cat=<?php echo $i['idCat'] ?>&id=<?php echo $i['id'] ?>"><?php echo $i['name'] ?></a></h6>
                            <h5><?php echo number_format($i['gia']); ?>đ</h5>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
